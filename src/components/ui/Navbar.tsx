    ...
    return (
        <motion.nav
            ...
            className={cn(
                ...
                scrolled ? "bg-cream border-b-4 border-black shadow-neo" : "bg-transparent"
            )}
        >
            ...
            <button className="md:hidden text-black uppercase text-sm font-bold border-2 border-black px-4 py-2 hover:bg-black hover:text-cream transition-all shadow-neo-sm active:translate-x-[2px] active:translate-y-[2px] active:shadow-none">
                Menu
            </button>
        </motion.nav>
    );
